class Game{
    ...
    play(){
        ...
        if(allPlayers!==undefined){
            background("gray");
            image(track, 0, (-displayHeight*5)/2, displayWidth, displayHeight*6);
            image(track, -3, (-displayHeight*5)*2, displayWidth, displayHeight*6);
    ...
    drawSprites();
        ...
        alert("Game Ended "+"RANK: "+player.rank);
    }
}